            ...
            for _, train_data in enumerate(train_loader):
                ...
                if (current_step) % opt['train']['val_freq'] == 0:
                    ...
                    for _,  val_data in enumerate(val_loader):
                        ...
                        # generation
                        Metrics.save_img(
                            hr_img, '{}/{}_{}_hr.pt'.format(result_hr_path, idx, dist.get_rank()))
                        Metrics.save_img(
                            sr_img, '{}/{}_{}_sr.pt'.format(result_sr_path, idx, dist.get_rank()))
                        Metrics.save_img(
                            lr_img, '{}/{}_{}_lr.pt'.format(result_lr_path, idx, dist.get_rank()))
